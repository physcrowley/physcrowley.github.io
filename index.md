...
## Leçons harmonisées pour les cours d'informatique
...
> #### 🚧🚧🚧 
>
> Cette version du site n'a pas été entièrement validée suite à sa génération. Notamment, plusieurs
> exemples et exercices n'ont pas été tirés du matériel source (sites existants) et doivent être 
> revu pour le contenu et le niveau. 
>
> Il est **fortement déconseillé** d'utiliser ce site à part pour un survol des critères d'apprentissage pour chaque leçon.
> 
